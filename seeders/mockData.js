  ...
  try {
    ...
    await OrderShare.bulkCreate([
      ...
      // Alice, Bob, Charlie are in Group 101
      {
        ...
        share_amount: 50.0,
        payment_status: "paid",
        paid_at: new Date("2025-05-10T11:00:00Z"),
      },
      {
        id: 3002,
        ORDER_id: 2001,
      ...
      },
      {
        ...
        share_amount: 25.5,
        payment_status: "paid",
        paid_at: new Date("2025-05-11T13:00:00Z"),
      },
      {
        id: 3006,
        ORDER_id: 2002,
      ...
      // Bob, Diana are in Group 102
      {
        ...
        share_amount: 20.0,
        payment_status: "paid",
        paid_at: new Date("2025-05-12T13:30:00Z"),
      },
      {
        id: 3008,
        ORDER_id: 2003,
        ...
        share_amount: 20.0,
        payment_status: "paid",
        paid_at: new Date("2025-05-12T13:35:00Z"),
      },
    ]);
...
if (require.main === module) {
  ...
  db.sequelize
    .sync({ alter: true }) // Use {force: true} to drop and recreate tables, {alter: true} to attempt to alter them.
